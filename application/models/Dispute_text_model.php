...
class Dispute_text_model extends CI_Model {
	...
	public function upload_image()
	{
		...
		$config_upload_image = $this->config->item('upload_image_dispute');
		$config_upload_image['upload_path'] .= $this->session->account_id."/dispute/".$this->dispute_id."/";
		...
		if (count($data['error']) == 0)
		{
			...
			$this->db->update($this->table_dispute_text);
		}
	}
