...
class Favorite_item_view_model extends CI_Model {
	...
	public function get($favorite_items)
	{
		...
		foreach($favorite_items as $favorite_item)
		{
			...
			if (strlen($favorite_item_temp->posted_item->posted_item_name) > ITEM_NAME_THUMBNAIL_MAX_CHAR)
			$favorite_item_temp->posted_item->posted_item_name = substr($favorite_item_temp->posted_item->posted_item_name, 0, ITEM_NAME_THUMBNAIL_MAX_CHAR - 3) . "...";
