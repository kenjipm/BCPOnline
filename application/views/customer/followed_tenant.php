				...
				<div class="row">
					...
					foreach($model->followed_tenants as $followed_tenant)
					{
						?>
							<div class="col-md-4">
								<div class="panel panel-default">
									<a href="<?=site_url('tenant/profile/'.$followed_tenant->id)?>">
										<div class="panel-body">
											<img class="col-md-12" src="<?=$followed_tenant->image_one_name?>" alt="<?=$followed_tenant->name?>"/>
										</div>
										<div class="panel-footer">
											<label class="control-label"><?=$followed_tenant->name?></label><br/>
