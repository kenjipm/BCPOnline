...
<div class="cb-panel-body cb-bg-primary-3 cb-m-5 cb-p-5">
	...
	<div class="cb-row">
		...
		<div class="cb-col-fifth">
			<div class="cb-label cb-font-title cb-align-center"> Total </div>
		</div>
	</div>
	<?php
	foreach($model->order_list as $order)
	{
		...
		<div class="cb-row cb-p-5 cb-border-top cb-table-striped">
			...
			<div class="cb-col-fifth">
				<div class="cb-align-center"> <?=$order->total_price?> </div>
			</div>
		</div>
		<?php
	}
	?>
	<div class="cb-row cb-pt-5 cb-border-top">
		<div class="cb-col-fifth">
		...
		<div class="cb-col-fifth">
			<div class="cb-label cb-font-title cb-font-size-lg cb-align-center"> <?=$model->billing_detail->total_payable?> </div>
		</div>
	</div>
</div>
