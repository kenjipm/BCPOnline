...
<div class="cb-panel-body cb-p-5">
	<div class="item-showcase cb-row">
		<?php
			...
			{
				?>
				<a href="<?=site_url('item/post_item_detail/'.$item->id)?>" class="cb-col-fifth cb-pb-3">
			...
			{
				?>
				<h4 class="cb-txt-secondary-1 cb-font-title cb-pl-5 cb-pr-5">Tidak ada service</h4>
				<?php
			}
			?>
		?>
